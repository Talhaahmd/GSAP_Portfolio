                    ...
                    <div className="col-lg-4">
                        ...
                        >
                            ...
                            <h2 className="text-white reveal-text mb-60 pb-60 border-bottom-opacity">
                                We are rated Rising Talent on Upwork
                            </h2>
                            <div className="d-flex align-items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white fz-font-sm mb-0 mt-2">
                                        Average 5 rating point <br /> reviews from 3 clients
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="d-flex flex-lg-nowrap flex-wrap gap-5 p-md-5 p-4">
                                ...
                                <div className="content">
                                    <p className="text-white fz-font-3xl fw-400 mb-50 lh-base">
                                        What stood out most was his commitment to quality. He was responsive, professional, and willing to refine the work until it met the required standard. I would be happy to work with him again and would recommend him to other clients looking for a reliable and capable freelancer.
                                    </p>
                                    <h5 className="text-white fw-500">Jeff Nippard</h5>
